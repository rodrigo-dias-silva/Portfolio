      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className='min-h-screen'>
          ...
          <div className='text-center p-10'>
            ...
            <h3 className='text-2xl py-2 md:text-3xl dark:text-gray-200'>Desenvolvedor Web e Mobile</h3>
            <p className='text-base py-5 leading-8 text-gray-800 dark:text-gray-200 md:text-xl max-w-xl mx-auto'>Amante de tecnologia e suas possibilidades, busco constantemente aprender e aprimorar minhas Skills para poder solucionar problemas e oportunidades. Vamos trabalhar juntos?</p>
          </div>
