      ...
      <div className="flex flex-col gap-2 py-10 px-5">
        ...
        <div className="flex flex-col gap-5">
          ...
          <ul className="flex gap-5">
            <li><a href="https://bit.ly/3xy2RXc" className="hover:text-teal-500"><WhatsappLogo size={50} weight="thin" /></a></li>
            <li><a href="https://bit.ly/3MdLzFi" className="hover:text-teal-500"><LinkedinLogo size={50} weight="thin" /></a></li>
            <li><a href="mailto:diglesilva@icloud.com" className="hover:text-teal-500"><Envelope size={50} weight="thin" /></a></li>
          </ul>
        </div>
      </div>
    </section>
